...
namespace App.Web.Areas.Admin.Controllers
{
    public class AccountController : AppControllerBase
	{
		...
		public AccountController(IHttpContextAccessor contextAccessor,IAccountService  accountService,IHostingEnvironment env, AppMailConfiguration mailConfig, GenericRepository repository, IMapper mapper) : base(mapper)
		{
		...
		[HttpPost]
		public async Task<IActionResult> ForgotPassword([FromServices] SystemEnv sysEnv, string email = "")
		{
		...
		[HttpPost]
		public async Task<IActionResult> CreateNewPass([FromServices] SystemEnv sysEnv,ForgotPassword model)
		{
